...
urlpatterns = [
    ...
    path("products/product-range/<slug:product_range_slug>/", products_view, name='products_list_by_range'),
    path("products/application-area/<slug:application_area_slug>/", products_view, name='products_list_by_application_area'),]